📂 P07-STUDY 저장소 설정 및 PR 가이드

이 문서는 p07-study 저장소의 초기 설정 내용과 팀원들이 협업을 위해 PR을 보내는 방법을 정리한 가이드입니다.

1. README.md (Raw Markdown 내용)

아래 내용을 전체 복사해서 최상위 루트의 README.md 파일에 그대로 붙여넣으세요. 실전 PR 단계, 주의사항, 그리고 첫 작업 체크리스트가 모두 포함되어 있습니다.
